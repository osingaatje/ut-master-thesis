...
#rq([
*RQ2*: To what extent are existing solutions suitable for use in autograding UTML diagrams with regards to (1) accuracy, (2) consistency, (3) grading transparency, (4) availability of source code, (5) extent of linking ILOs to grading instructions, (6) ease of integration into the grading process, and (7) UTML support?
])
...
Autograder frameworks dictate a certain design or methodology for building an autograder. We present summaries of the explored frameworks and provide a general summary of all frameworks.
...
To maximise the flexibility of each individual component, we aim to implement a query-based architecture akin to that of the Rust compiler @rustc-book, of which a draft architecture can be seen in @fig:arch. This encourages decoupling the input parsing, the algorithm, and output formatting. This additionally supports transparency internally in the grading process, as one can easily query intermediate solutions from the grading process. Testing is also inherently made easier due to the split-up functionality.
    ...
    table(
      columns: (auto,auto,auto,auto,1fr),
        ...
        table.header(
          ...
          [Wk.], [12],[-],[13],   [ #seshat - implement/verify/document *syntactic* matching algorithm(s) @Bian2020 @thomas2009 @smith2013 ], table.hline(),
          [Wk.], [14],[-],[15],    [ #seshat - implement/verify/document *semantic* matching algorithm(s) @Bian2020 @thomas2009 @smith2013 ], table.hline(),
          [Wk.], [16],[-],[17],   [ #seshat - implement/verify/document *structural* matching algorithm(s) @Bian2020 @thomas2009 @smith2013 ], table.hline(),
          [Wk.], [18],[-],[19],   [ #seshat - combine/verify/document algorithms @Bian2020 @thomas2009 @smith2013 ], table.hline(),
          [Wk.], [20],[-],[21],   [ #seshat - combine/verify/document algorithms @Bian2020 @thomas2009 @smith2013, \ compare to manual grading, document comparisons ], table.hline(),
          [Wk.], [22],[-],[23],   [ #seshat - compare to manual grading, document results in paper ], table.hline(),
